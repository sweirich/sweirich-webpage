...
* *The pleasure and pain of advanced type systems.*  
...
* *A POPLmark retrospective: Using proof assistants in
...
* *Generic Binding and Telescopes.*  
  WG 2.8, Marble Falls, TX. March 11, 2011

* *ICFP 2010 Program Chair's report.*
...
* *A POPLmark retrospective: Using proof assistants in programming
  language research.*   
...
* *Haskell Symposium 2009 Program Chair's report.* 
...
* *First-class Polymorphism for Haskell.*  
...
* *A Core Language for Generalised Algebraic Datatypes.*  
  International Federation for Information Processing 
...
* *2004 ICFP Programming Contest Results.*  
...
* *Boxes Go Bananas: Parametric Higher-Order Abstract Syntax
  in System F.*  
  Laboratory for Secure Systems Seminar, Stevens
  Institute of Technology. Hoboken, NJ. May 5, 2003
  
* *Run-time type analysis in Haskell with an Awful Lot of
  Newtypes.*  
  International Federation for Information Processing
...
* *Run-Time Type Analysis and Program Verification.*  
  Research, Careers and Computer Science: A Maryland Symposium. 
  University of Maryland, College Park, MD. November 2001
 
* *Polytypic Programming and Intensional Type Constructor Analysis.*  
