...
Require Export HOAS_Untyped_Definitions.
  ...
  Case "typing_case".
    ...
    SCase "Val1".
      ...
      SSCase "Left J1".
        ...
        assert (expr (exp_case (exp_inl e4) left e2 right e3)) by auto.
        inversion H3...
      SSCase "Right J1".
        subst.
        exists (open_ee e3 e4)...
        inversion Val1; subst.
        assert (expr (exp_case (exp_inr e4) left e2 right e3)) by auto.
        inversion H3...
Qed.
